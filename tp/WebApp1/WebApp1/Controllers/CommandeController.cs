...
namespace WebApp1.Controllers
{
    public class CommandeController : Controller
    {
        ...
        {
            var commandeContexte = _context.Commandes.Include(r => r.Restaurant)
                .Include(p => p.Pizza);

            return View(await commandeContexte.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Commande commande)
        {
            if (id != commande.Id)
            {
                return NotFound();
